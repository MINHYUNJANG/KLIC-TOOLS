    ...
    <div className="crawl-page">
      <div className="crawl-page-inner">
        <div className="crawl-title-row">
          ...
          <button type="button" className="crawl-help-btn" onClick={() => setShowHelp(true)} aria-label="웹접근성검사 사용방법 열기">?</button>
        </div>
        ...
        {showHelp && (
          <InspectionHelpModal
            ...
            steps={[
              { title: '검사 URL 입력', description: '접근성을 검사할 페이지 주소를 입력하고 검사 시작을 누릅니다.' },
              { title: '검사 결과 확인', description: 'HTML을 자동 수집해 W3C 기반 오류·경고·정보 항목을 한글로 확인합니다.' },
              { title: '문제 소스 찾기', description: '왼쪽 결과 항목을 클릭하면 오른쪽 소스의 해당 줄로 이동합니다.' },
              { title: '조치 및 자동 수정', description: '문제 줄에 마우스를 올려 조치방법을 확인하고 지원 항목은 자동 수정합니다.' },
            ]}
          />
        )}
