  ...
  return (
    <div className="bm-page">
      ...
      <div className="bm-header">
        ...
        <PageHowTo title="Figma API 토큰 없이 마크업을 붙여넣고 바로 활용하세요" style={{ marginBottom: 0 }}>
          <p>
            Claude 채팅에서 Figma URL을 MCP로 분석한 후 생성된 HTML/CSS를 복사하세요.<br />
            아래 입력창에 붙여넣으면 <strong>미리보기·복사·다운로드</strong>를 바로 사용할 수 있습니다.
          </p>
        </PageHowTo>
      </div>
