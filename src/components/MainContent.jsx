...
import GreetingBuilderPage from './pages/menu02/template-builder/greeting-builder/GreetingBuilderPage';
import HistoryBuilderPage from './pages/menu02/template-builder/history-builder/HistoryBuilderPage';
import PrincipalBuilderPage from './pages/menu02/template-builder/principal-builder/PrincipalBuilderPage';
import SymbolBuilderPage from './pages/menu02/template-builder/symbol-builder/SymbolBuilderPage';
...
export default function MainContent({ currentPage, setCurrentPage }) {
  ...
  if (currentPage === 'greeting-builder') return <GreetingBuilderPage />;
  if (currentPage === 'history-builder') return <HistoryBuilderPage />;
  if (currentPage === 'principal-builder') return <PrincipalBuilderPage />;
  if (currentPage === 'symbol-builder') return <SymbolBuilderPage />;
