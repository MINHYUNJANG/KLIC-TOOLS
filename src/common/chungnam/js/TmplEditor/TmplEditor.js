...
</div>`,src:`/00_common/images/templates/greeting-tyA.png`},{id:`greeting-tyA-img`,name:`인사말 타입 A (배너형 + 이미지)`,html:`<div class="greeting tyA ty-img">
	<div class="lead-wrap">
		<div class="img"><p><img src="/00_common/images/sub_com/greeting_A_temp.png" alt="교장 홍길동 사진"></p></div>
		<div class="inner">
			<p>더 <strong>강한 학교</strong>로 <br>더 <strong>빛나는 미래</strong>를 향해</p>
			<div class="bg-text">
				<div class="track">
...
</div>`,src:`/00_common/images/templates/greeting-tyA-img.png`},{id:`greeting-tyB`,name:`인사말 타입 B (컬러 리드형)`,html:`<div class="greeting tyB">
	<div class="container">
		<div class="inner">
			<div class="lead-wrap">
				<div class="lead-txt">
			...
			<div class="txt-wrap">
				<div class="txt">
					...
					<p>
						또한, 학교는 학부모님과 지역사회와 함께할 때 더욱 든든해집니다. <br>
						학부모님들께서 보내주시는 따뜻한 관심과 격려, 그리고 지역사회의 아낌없는 지원은 우리 아이들이 행복하게 성장할 수 있는 큰 힘이 됩니다.
					</p>
					<p>
						앞으로도 모든 분들께 사랑받는 학교, 신뢰받는 학교가 되도록 최선을 다하겠습니다.
					</p>
					<p>감사합니다.</p>
				</div>
			</div>
...
</div>`,src:`/00_common/images/templates/greeting-tyB.png`},{id:`greeting-tyB-img`,name:`인사말 타입 B (컬러 리드형 + 이미지)`,html:`<div class="greeting tyB ty-img">
	<div class="container">
		<div class="img-wrap">
			<div class="img">
		...
		<div class="inner">
			...
			<div class="txt-wrap">
				<div class="txt">
					...
					<p>
						이를 위해 우리 교직원 모두는 학생 한 명 한 명의 눈높이에 맞춘 교육을 실천하고, 미래 사회를 살아갈 힘을 기를 수 있도록 다양한 교육 활동을 펼쳐 나가겠습니다.
					</p>
					<p>감사합니다.</p>
				</div>
			</div>
...
</div>`,src:`/00_common/images/templates/greeting-tyB-img.png`},{id:`greeting-tyC`,name:`인사말 타입 C (사이드 오브젝트형)`,html:`<div class="greeting tyC">
	<div class="container">
		<div class="obj">
			...
			<div class="txt-wrap">
				<div class="txt">
					...
					<p>케이엘 학교는 단순히 지식을 전달하는 곳이 아닙니다.<br>
						아이들이 꿈을 키우고, 친구들과 함께 성장하며, 세상을 바라보는 넓은 시각을 기를 수 있는 따뜻한 보금자리입니다.
					</p>
					<p>감사합니다.</p>
				</div>
				<div class="sign">케이엘학교 교장 <strong>홍 길 동</strong></div>
...
</div>`,src:`/00_common/images/templates/greeting-tyC.png`},{id:`greeting-tyC-img`,name:`인사말 타입 C (사이드 오브젝트형 + 이미지)`,html:`<div class="greeting tyC ty-img">
	<div class="container">
		<div class="obj">
			<p class="mask mask1"></p>
			<p class="mask mask2"></p>
		...
		<div class="inner">
...
</div>`,src:`/00_common/images/templates/greeting-tyC-img.png`}],history:[{id:`history-tyA`,name:`연혁 타입 A (스크롤 슬라이드형)`,html:`<div class="history tyA">
			<div class="history-sticky">
				...
				<div class="timeline">
					...
					<details>
					<summary>연도 관리</summary>
					</details>
				</div>
			</div>
		</div>`,src:`/00_common/images/templates/history-tyA.png`},{id:`history-tyB-img`,name:`연혁 타입 B (탭 세로형+배경 이미지)`,html:`<div class="history tyB ty-img">
	<div class="container">
		<!-- 이미지 있을 시, -->
...
</div>`,src:`/00_common/images/templates/history-tyB-img.png`},{id:`history-tyB`,name:`연혁 타입 B (탭 세로형)`,html:`<div class="history tyB">
	<div class="container">
		<div class="inner">
			<div class="history-sticky">
				<!-- 중앙 year -->
...
</div>`,src:`/00_common/images/templates/history-tyB.png`},{id:`history-tyC`,name:`연혁 타입 C (기본형)`,html:`<div class="history tyC">
	<div class="container">
...
</div>`,src:`/00_common/images/templates/history-tyC.png`}],principal:[{id:`principal-tyA-slide`,name:`역대교장 타입 A (슬라이드형)`,html:`<div class="pri-his tyA slide wideCnt">
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					...
					<div class="popup-data">
						<details>
						<summary>약력 팝업 내용 편집</summary>
						<div class="pri-his popup">
							<div class="popup-wrap">
								...
								<div class="list-wrap">
									...
									<ul>
										<li><strong>1982</strong><p>00대학교 00학과 졸업</p></li>
										<li><strong>1985</strong><p>00대학교 대학원 졸업</p></li>
									</ul>
									<h4 class="tit-st unit">주요 업적</h4>
									<ul>
										<li><strong>1999</strong><p>영어전용교실 개설</p></li>
										<li><strong>2000</strong><p>국제교류 준비위원회 구성</p></li>
										<li><strong>2003 ~ 2004</strong><p>교육시설 친환경 개선사업 착수</p></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="card">
						<div class="inner">
							...
							<div class="info">
								...
								<p><strong>홍길동</strong> 교장</p>
								<div class="term"><strong>재임기간</strong> 2020.03.01. ~ 2022.02.28.</div>
							</div>
							<p class="bg" aria-hidden="true"></p>
						</div>
						<a href="" class="btn-view">약력보기</a>
					...
					<div class="card">
						<div class="inner">
							...
							<div class="info">
								...
								<p><strong>홍길동</strong> 교장</p>
								<div class="term"><strong>재임기간</strong> 2017.03.01. ~ 2019.02.28.</div>
							</div>
							<p class="bg" aria-hidden="true"></p>
						</div>
						<a href="" class="btn-view">약력보기</a>
					...
					<div class="card">
						<div class="inner">
							...
							<div class="info">
								...
								<p><strong>홍길동</strong> 교장</p>
								<div class="term"><strong>재임기간</strong> 2014.03.01. ~ 2016.02.29.</div>
							</div>
							<p class="bg" aria-hidden="true"></p>
						</div>
						<a href="" class="btn-view">약력보기</a>
					...
					<div class="card">
						<div class="inner">
							...
							<div class="info">
								...
								<p><strong>홍길동</strong> 교장</p>
								<div class="term"><strong>재임기간</strong> 2011.03.01. ~ 2013.02.28.</div>
							</div>
							<p class="bg" aria-hidden="true"></p>
						</div>
						<a href="" class="btn-view">약력보기</a>
					...
					<div class="card">
						<div class="inner">
							...
							<div class="info">
								...
								<p><strong>홍길동</strong> 교장</p>
								<div class="term"><strong>재임기간</strong> 2008.03.01. ~ 2010.02.28.</div>
							</div>
							<p class="bg" aria-hidden="true"></p>
						</div>
						<a href="" class="btn-view">약력보기</a>
...
</div>`,src:`/00_common/images/templates/principal-tyA-slide.png`},{id:`principal-tyA-list`,name:`역대교장 타입 A (목록형)`,html:`<div class="pri-his tyA list">
			...
			<li>
				<div class="inner">
					...
					<div class="info">
						...
						<p><strong>홍길동</strong> 교장</p>
						<div class="term"><strong>재임기간</strong> 2005.03.01. ~ 2007.02.28.</div>
					</div>
				</div>
				<a href="" class="btn-view">약력보기</a>
				<div class="popup-data">
			...
			<li>
				<div class="inner">
					...
					<div class="info">
						...
						<p><strong>홍길동</strong> 교장</p>
						<div class="term"><strong>재임기간</strong> 2002.03.01. ~ 2004.02.29.</div>
					</div>
				</div>
				<a href="" class="btn-view">약력보기</a>
				<div class="popup-data">
...
</div>`,src:`/00_common/images/templates/principal-tyA-list.png`},{id:`principal-tyB`,name:`역대교장 타입 B (원형사진 그리드형)`,html:`<div class="pri-his tyB wideCnt">
...
</div>`,src:`/00_common/images/templates/principal-tyB.png`},{id:`principal-tyC`,name:`역대교장 타입 C (카드형)`,html:`<div class="pri-his tyC">
	<div class="list-wrap">
		<!-- 역대교장 List -->
		<ul>
			<li>
...
</div>`,src:`/00_common/images/templates/principal-tyC.png`},{id:`principal-tyC-img`,name:`역대교장 타입 C (카드형 + 이미지)`,html:`<div class="pri-his tyC ty-img">
	<div class="list-wrap">
		<!-- 역대교장 List -->
		<ul>
			<li>
...
`,src:`/00_common/images/templates/principal-tyC-img.png`}],symbol:[{id:`symbol-tyA`,name:`상징 타입 A (스크롤 세로형)`,html:`<div class="symbol tyA list">
	...
	<div class="list-wrap">
		...
		<div class="box song-wrap">
			<div class="tit-wrap">
				<h4>교가</h4>
				<div class="btn-wrap">
					<button class="btn-st pri edu-audio-btn" type="button">교가듣기</button>
					<a class="btn-st sec edu-score-link" href="" download>악보다운로드</a>
					<audio class="edu-audio" controls src=""></audio>
				</div>
			</div>
			<div class="inner">
...
</div>`,src:`/00_common/images/templates/symbol-tyA.png`},{id:`symbol-tyB`,name:`상징 타입 B (스크롤 가로형)`,html:`<div class="symbol tyA slide">
...
</div>`,src:`/00_common/images/templates/symbol-tyB.png`},{id:`symbol-tyC`,name:`심볼 타입 C (내용 축약형)`,html:`<div class="symbol tyB tyB_1">
	<div class="box">
		<div class="inner">                        
			<p class="slogan">
				정직ㆍ사랑ㆍ꿈을 가꾸는 어린이
...
</div>`,src:`/00_common/images/templates/symbol-tyC.png`},{id:`symbol-tyD`,name:`심볼 타입 D (박스형)`,html:`<div class="symbol tyB tyB_2">
	<div class="symbol-sticky">
		<h4>정직ㆍ사랑ㆍ꿈을 가꾸는 어린이</h4>
	</div>
...
</div>`,src:`/00_common/images/templates/symbol-tyD.png`},{id:`symbol-tyE`,name:`심볼 타입 E (타이틀 분할형)`,html:`<div class="symbol tyC">
	<div class="symbol-sticky">
...
</div>`,src:`/00_common/images/templates/symbol-tyE.png`}]},m=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),h=e(((e,t)=>{t.exports=m()})),g=f(),_=h(),v={greeting:`인사말`,history:`연혁`,principal:`역대교장`,symbol:`상징`};function y(e){let t=(0,g.c)(2),{onSelect:n}=e,r=window.EDITOR_TYPE||`greeting`,i=r===`all`,a;return t[0]===n?a=t[1]:(a=(0,_.jsx)(`div`,{className:`template-bar`,children:(i?Object.entries(p):[[r,p[r]??[]]]).map(e=>{let[t,r]=e;return(0,_.jsxs)(`div`,{className:`template-bar-group`,children:[i&&(0,_.jsx)(`span`,{className:`template-bar-group-label`,children:v[t]}),r.map(e=>(0,_.jsxs)(`div`,{className:`template-bar-item`,onClick:()=>n(e.html,e.id),style:{cursor:`pointer`},children:[(0,_.jsx)(`div`,{className:`template-bar-thumb`,children:e.src?(0,_.jsx)(`img`,{src:e.src,alt:e.name}):(0,_.jsx)(`span`,{children:`📄`})}),(0,_.jsx)(`div`,{className:`template-bar-name`,children:e.name})]},e.id))]},t)})}),t[0]=n,t[1]=a),a}var b=[{label:`기본`,primary:`#7c3aed`,secondary:`#a78bfa`,accent:`#ec4899`},{label:`파랑`,primary:`#1d4ed8`,secondary:`#3b82f6`,accent:`#f59e0b`},{label:`초록`,primary:`#15803d`,secondary:`#22c55e`,accent:`#f59e0b`},{label:`빨강`,primary:`#dc2626`,secondary:`#f87171`,accent:`#f97316`},{label:`주황`,primary:`#c2410c`,secondary:`#fb923c`,accent:`#facc15`},{label:`청록`,primary:`#0f766e`,secondary:`#14b8a6`,accent:`#eab308`}],x=[{key:`primary`,label:`주색상`},{key:`secondary`,label:`보조색상`},{key:`accent`,label:`포인트`}];function S(e){let t=(0,g.c)(20),{colors:n,onChange:r}=e,i;t[0]===r?i=t[1]:(i=e=>{r({primary:e.primary,secondary:e.secondary,accent:e.accent})},t[0]=r,t[1]=i);let a=i,o,s,c;t[2]===Symbol.for(`react.memo_cache_sentinel`)?(o={display:`flex`,alignItems:`center`,gap:`16px`,padding:`8px 16px`,backgroundColor:`#f8fafc`,borderBottom:`1px solid #e2e8f0`,flexWrap:`wrap`},s=(0,_.jsx)(`span`,{style:{fontSize:`12px`,fontWeight:600,color:`#64748b`,flexShrink:0},children:`테마`}),c={display:`flex`,gap:`6px`,alignItems:`center`},t[2]=o,t[3]=s,t[4]=c):(o=t[2],s=t[3],c=t[4]);let l;t[5]!==n||t[6]!==a?(l=b.map(e=>{let t=n.primary===e.primary;return(0,_.jsx)(`button`,{type:`button`,title:e.label,onClick:()=>a(e),style:{width:`22px`,height:`22px`,borderRadius:`50%`,backgroundColor:e.primary,border:t?`2px solid #0f172a`:`2px solid transparent`,outline:t?`2px solid #fff`:`none`,outlineOffset:`-3px`,cursor:`pointer`,flexShrink:0,transition:`transform 0.1s`},onMouseEnter:w,onMouseLeave:C},e.label)}),t[5]=n,t[6]=a,t[7]=l):l=t[7];let u;t[8]===l?u=t[9]:(u=(0,_.jsx)(`div`,{style:c,children:l}),t[8]=l,t[9]=u);let d,f;t[10]===Symbol.for(`react.memo_cache_sentinel`)?(d=(0,_.jsx)(`div`,{style:{width:`1px`,height:`20px`,backgroundColor:`#e2e8f0`,flexShrink:0}}),f={display:`flex`,gap:`12px`,alignItems:`center`},t[10]=d,t[11]=f):(d=t[10],f=t[11]);let p;t[12]!==n||t[13]!==r?(p=x.map(e=>{let{key:t,label:i}=e;return(0,_.jsxs)(`label`,{style:{display:`flex`,alignItems:`center`,gap:`5px`,cursor:`pointer`,fontSize:`12px`,color:`#475569`,fontWeight:500},children:[(0,_.jsxs)(`div`,{style:{position:`relative`,width:`24px`,height:`24px`},children:[(0,_.jsx)(`div`,{style:{width:`24px`,height:`24px`,borderRadius:`4px`,backgroundColor:n[t],border:`1px solid #cbd5e1`,pointerEvents:`none`}}),(0,_.jsx)(`input`,{type:`color`,value:n[t],onChange:e=>r({...n,[t]:e.target.value}),style:{position:`absolute`,inset:0,opacity:0,cursor:`pointer`,width:`100%`,height:`100%`}})]}),i]},t)}),t[12]=n,t[13]=r,t[14]=p):p=t[14];let m;t[15]===p?m=t[16]:(m=(0,_.jsx)(`div`,{style:f,children:p}),t[15]=p,t[16]=m);let h;return t[17]!==m||t[18]!==u?(h=(0,_.jsxs)(`div`,{style:o,children:[s,u,d,m]}),t[17]=m,t[18]=u,t[19]=h):h=t[19],h}function C(e){e.currentTarget.style.transform=`scale(1)`}function w(e){e.currentTarget.style.transform=`scale(1.2)`}function T(e,t,n){if(e.collapsed)return;let r=()=>{let e=document.createElement(t);return n&&(e.className=n),e};if(e.startContainer===e.endContainer){e.surroundContents(r());return}let i=document.createTreeWalker(e.commonAncestorContainer,NodeFilter.SHOW_TEXT),a=[],o;for(;o=i.nextNode();)e.intersectsNode(o)&&a.push(o);a.forEach(t=>{let n=document.createRange();n.setStart(t,t===e.startContainer?e.startOffset:0),n.setEnd(t,t===e.endContainer?e.endOffset:t.length),n.collapsed||n.surroundContents(r())})}function ee(e){let t=e.parentNode;if(t){for(;e.firstChild;)t.insertBefore(e.firstChild,e);t.removeChild(e)}}function te(e){let t=new Set([`strong`,`em`,`u`,`s`,`b`,`i`]),n=e.commonAncestorContainer.nodeType===Node.TEXT_NODE?e.commonAncestorContainer.parentElement:e.commonAncestorContainer,r=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),i=[],a;for(;a=r.nextNode();)e.intersectsNode(a)&&i.push(a);let o=new Set;i.forEach(e=>{let n=e.parentElement;for(;n&&n.getAttribute?.(`contenteditable`)!==`true`;){if(o.has(n)){n=n.parentElement;continue}o.add(n);let e=n.tagName?.toLowerCase(),r=t.has(e),i=e===`span`&&/\bclr-/.test(n.className);if(r||i){let e=n.parentElement;ee(n),n=e}else n.classList?.remove(`clr-pri`,`clr-sub`,`clr-accent`),n=n.parentElement}})}function E(e){let t=(0,g.c)(49),{visible:n,position:r,savedRangeRef:i,colors:a,onApply:o}=e;if(!n)return null;let s;t[0]!==o||t[1]!==i?(s=e=>{let t=i.current;if(!t)return;let n=window.getSelection();n.removeAllRanges(),n.addRange(t),e(t),n.removeAllRanges(),o()},t[0]=o,t[1]=i,t[2]=s):s=t[2];let c=s,l;t[3]!==r.left||t[4]!==r.top?(l={top:r.top,left:r.left},t[3]=r.left,t[4]=r.top,t[5]=l):l=t[5];let u;t[6]===a.primary?u=t[7]:(u={color:a.primary},t[6]=a.primary,t[7]=u);let d;t[8]===c?d=t[9]:(d=()=>c(se),t[8]=c,t[9]=d);let f;t[10]!==u||t[11]!==d?(f=(0,_.jsx)(`button`,{className:`sel-btn`,title:`주색상`,style:u,onClick:d,children:`A`}),t[10]=u,t[11]=d,t[12]=f):f=t[12];let p;t[13]===a.secondary?p=t[14]:(p={color:a.secondary},t[13]=a.secondary,t[14]=p);let m;t[15]===c?m=t[16]:(m=()=>c(oe),t[15]=c,t[16]=m);let h;t[17]!==p||t[18]!==m?(h=(0,_.jsx)(`button`,{className:`sel-btn`,title:`보조색상`,style:p,onClick:m,children:`A`}),t[17]=p,t[18]=m,t[19]=h):h=t[19];let v;t[20]===a.accent?v=t[21]:(v={color:a.accent},t[20]=a.accent,t[21]=v);let y;t[22]===c?y=t[23]:(y=()=>c(ae),t[22]=c,t[23]=y);let b;t[24]!==y||t[25]!==v?(b=(0,_.jsx)(`button`,{className:`sel-btn`,title:`강조색상`,style:v,onClick:y,children:`A`}),t[24]=y,t[25]=v,t[26]=b):b=t[26];let x;t[27]===Symbol.for(`react.memo_cache_sentinel`)?(x=(0,_.jsx)(`span`,{className:`sel-divider`}),t[27]=x):x=t[27];let S;t[28]===c?S=t[29]:(S=(0,_.jsx)(`button`,{className:`sel-btn`,title:`굵게`,onClick:()=>c(ie),children:`B`}),t[28]=c,t[29]=S);let C;t[30]===c?C=t[31]:(C=(0,_.jsx)(`button`,{className:`sel-btn fmt-italic`,title:`기울임`,onClick:()=>c(re),children:`I`}),t[30]=c,t[31]=C);let w;t[32]===c?w=t[33]:(w=(0,_.jsx)(`button`,{className:`sel-btn fmt-under`,title:`밑줄`,onClick:()=>c(D),children:`U`}),t[32]=c,t[33]=w);let T;t[34]===c?T=t[35]:(T=(0,_.jsx)(`button`,{className:`sel-btn fmt-strike`,title:`취소선`,onClick:()=>c(ne),children:`S`}),t[34]=c,t[35]=T);let ee;t[36]===Symbol.for(`react.memo_cache_sentinel`)?(ee=(0,_.jsx)(`span`,{className:`sel-divider`}),t[36]=ee):ee=t[36];let E;t[37]===c?E=t[38]:(E=(0,_.jsx)(`button`,{className:`sel-btn sel-clear`,title:`서식 지우기`,onClick:()=>c(te),children:`×`}),t[37]=c,t[38]=E);let k;return t[39]!==b||t[40]!==S||t[41]!==C||t[42]!==w||t[43]!==T||t[44]!==E||t[45]!==l||t[46]!==f||t[47]!==h?(k=(0,_.jsxs)(`div`,{className:`selection-toolbar`,style:l,onMouseDown:O,children:[f,h,b,x,S,C,w,T,ee,E]}),t[39]=b,t[40]=S,t[41]=C,t[42]=w,t[43]=T,t[44]=E,t[45]=l,t[46]=f,t[47]=h,t[48]=k):k=t[48],k}function ne(e){return T(e,`s`)}function D(e){return T(e,`u`)}function re(e){return T(e,`em`)}function ie(e){return T(e,`strong`)}function ae(e){return T(e,`span`,`clr-accent`)}function oe(e){return T(e,`span`,`clr-sub`)}function se(e){return T(e,`span`,`clr-pri`)}function O(e){e.preventDefault(),e.stopPropagation()}function k(e){let t=(0,g.c)(18),{block:n,onDelete:r,onClone:i,onDragStart:a,onMouseEnter:o,onMouseLeave:s}=e;if(!n)return null;let c;t[0]===n?c=t[1]:(c=n.getBoundingClientRect(),t[0]=n,t[1]=c);let l=c,u=Math.min(l.right+6,window.innerWidth-40),d;t[2]!==u||t[3]!==l.top?(d={top:l.top,left:u},t[2]=u,t[3]=l.top,t[4]=d):d=t[4];let f;t[5]===a?f=t[6]:(f=(0,_.jsx)(`button`,{type:`button`,className:`blk-btn blk-drag`,title:`드래그하여 순서 변경`,onMouseDown:e=>{e.preventDefault(),a()},children:`⣿`}),t[5]=a,t[6]=f);let p;t[7]===i?p=t[8]:(p=(0,_.jsx)(`button`,{type:`button`,className:`blk-btn`,title:`복제`,onClick:i,children:`⊕`}),t[7]=i,t[8]=p);let m;t[9]===r?m=t[10]:(m=(0,_.jsx)(`button`,{type:`button`,className:`blk-btn blk-del`,title:`삭제`,onClick:r,children:`✕`}),t[9]=r,t[10]=m);let h;return t[11]!==o||t[12]!==s||t[13]!==d||t[14]!==f||t[15]!==p||t[16]!==m?(h=(0,_.jsxs)(`div`,{className:`blk-overlay`,style:d,onMouseEnter:o,onMouseLeave:s,onMouseDown:ce,children:[f,p,m]}),t[11]=o,t[12]=s,t[13]=d,t[14]=f,t[15]=p,t[16]=m,t[17]=h):h=t[17],h}function ce(e){return e.preventDefault()}function le(){document.querySelectorAll(`.ico[data-ico]`).forEach(e=>{let t=e.getAttribute(`data-ico`),n=``;switch(t){case`ico-box1`:n=`<svg width="50" height="57" viewBox="0 0 50 57" fill="none"><g clip-path=""><path d="M35.6 55.4799H14.25L19.78 43.3599H30.07L35.6 55.4799Z" class="stroke-primary fill-white" stroke-width="2.5"/><path d="M48.59 40.8198C48.59 42.7498 47.03 44.3098 45.1 44.3098H4.74C2.81 44.3098 1.25 42.7498 1.25 40.8198V8.57984C1.25 6.64984 2.81 5.08984 4.74 5.08984H45.1C47.03 5.08984 48.59 6.64984 48.59 8.57984V40.8198Z" class="stroke-primary fill-tertiary" stroke-width="2.5"/><path d="M12.6396 36.1997H37.1996" class="stroke-primary" stroke-width="2.5"/><path d="M36.8502 13.18C36.8502 19.77 31.5102 25.11 24.9202 25.11C18.3302 25.11 12.9902 19.77 12.9902 13.18C12.9902 6.59 18.3302 1.25 24.9202 1.25C31.5102 1.25 36.8502 6.59 36.8502 13.18Z" class="stroke-accent fill-white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M19.7305 13.2798L23.7705 17.3198L30.1105 9.0498" class="fill-white"/><path d="M19.7305 13.2798L23.7705 17.3198L30.1105 9.0498" class="stroke-accent" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>`;break;default:break}n&&e.innerHTML!==n&&(e.innerHTML=n)})}var A=`blk-handle`,ue=`sub-blk-btn`;function j(e,t,n){let r=document.createElement(`button`);return r.type=`button`,r.className=`${ue} ${t}`,r.textContent=e,r.contentEditable=`false`,r.addEventListener(`mousedown`,e=>{e.preventDefault(),e.stopPropagation()}),r.addEventListener(`click`,e=>{e.stopPropagation(),n()}),r}function M(e,t){e.querySelectorAll(`.${ue}`).forEach(e=>e.remove()),e.querySelectorAll(`.list-wrap > ul > li`).forEach(n=>{n.appendChild(j(`×`,`sub-del-li`,()=>t.onLiDelete(n,e)))}),e.querySelectorAll(`.list-wrap > ul`).forEach(n=>{n.after(j(`+ 항목 추가`,`sub-add-li`,()=>t.onLiAdd(n,e)))}),e.querySelectorAll(`.list-wrap > h4`).forEach(n=>{n.appendChild(j(`× 섹션 삭제`,`sub-del-section`,()=>t.onSectionDelete(n,e)))});let n=e.querySelector(`.list-wrap`);n&&n.appendChild(j(`+ 섹션 추가`,`sub-add-section`,()=>t.onSectionAdd(e))),e.querySelectorAll(`dl.his dd ul > li`).forEach(n=>{n.appendChild(j(`×`,`sub-del-li`,()=>t.onLiDelete(n,e)))}),e.querySelectorAll(`dl.his dd ul`).forEach(n=>{n.after(j(`+ 항목 추가`,`sub-add-li`,()=>t.onLiAdd(n,e)))}),e.querySelectorAll(`dl.his`).forEach(n=>{n.appendChild(j(`× 섹션삭제`,`sub-del-dl`,()=>t.onDlDelete(n,e)))});let r=e.querySelectorAll(`dl.his`),i=j(`+ 학력/업적 섹션 추가`,`sub-add-dl`,()=>t.onDlAdd(e));if(r.length>0?r[r.length-1].after(i):e.closest(`.detail-data`)&&e.appendChild(i),e.closest(`.historySwiper`)){e.querySelectorAll(`strong`).forEach(n=>{n.appendChild(j(`×`,`sub-del-li`,()=>t.onTypaItemDelete(n,e)))});let n=[...e.querySelectorAll(`p`)].at(-1),r=j(`+ 항목 추가`,`sub-add-li`,()=>t.onTypaItemAdd(e));n?n.after(r):e.appendChild(r)}if(e.closest(`.history.tyA`)&&e.closest(`.timeline`)&&e.appendChild(j(`+ 연도 추가`,`sub-add-year`,()=>t.onTypaYearAdd(e))),e.closest(`.year`)){e.querySelectorAll(`ul > li`).forEach(n=>{n.appendChild(j(`× 삭제`,`sub-del-tab`,()=>t.onTabDelete(n,e)))});let n=[...e.querySelectorAll(`ul > li`)].at(-1),r=j(`+ 탭 추가`,`sub-add-tab`,()=>t.onTabAdd(e));n?n.after(r):e.querySelector(`ul`)?.appendChild(r)}if(e.closest(`.history`)&&e.closest(`.list`)&&!e.closest(`dd`)&&!e.closest(`.historySwiper`)){let n=[...e.querySelectorAll(`:scope > dl`)].at(-1),r=j(`+ 연도 추가`,`sub-add-year`,()=>t.onYearAdd(e));n?n.after(r):e.appendChild(r)}if(e.closest(`.history`)&&e.closest(`dd`)&&(e.querySelectorAll(`ul > li`).forEach(n=>{n.appendChild(j(`×`,`sub-del-li`,()=>t.onLiDelete(n,e)))}),e.querySelectorAll(`ul`).forEach(n=>{n.after(j(`+ 항목 추가`,`sub-add-li`,()=>t.onHistoryLiAdd(n,e)))})),e.closest(`.lyr`)){e.querySelectorAll(`dl`).forEach(n=>{n.appendChild(j(`× 삭제`,`sub-del-verse`,()=>t.onVerseDelete(n,e)))});let n=[...e.querySelectorAll(`dl`)].at(-1);n?n.after(j(`+ 절 추가`,`sub-add-verse`,()=>t.onVerseAdd(e))):e.appendChild(j(`+ 절 추가`,`sub-add-verse`,()=>t.onVerseAdd(e)))}e.closest(`.his-wrap`)&&(e.querySelectorAll(`dl > dd > p.bu-st3`).forEach(n=>{n.appendChild(j(`×`,`sub-del-p`,()=>t.onPDelete(n,e)))}),e.querySelectorAll(`dl > dd`).forEach(n=>{n.appendChild(j(`+ 항목 추가`,`sub-add-p`,()=>t.onPAdd(n,e)))}),e.querySelectorAll(`dl`).forEach(n=>{n.appendChild(j(`× 섹션 삭제`,`sub-del-hisdl`,()=>t.onHisDlDelete(n,e)))}),e.appendChild(j(`+ 섹션 추가`,`sub-add-hisdl`,()=>t.onHisDlAdd(e))))}function N(e,t,n){let r=(0,l.useRef)(n);r.current=n;let i=(0,l.useRef)({}),a=(0,l.useRef)(()=>{}),o=(0,l.useCallback)(()=>{r.current(he(e.current.innerHTML))},[e]);return i.current={onLiDelete(e,t){e.remove(),M(t,i.current),o()},onLiAdd(e,t){let n=document.createElement(`li`);n.innerHTML=e.closest(`dl.his`)?`<strong>연도</strong><div class="inr"><p>내용을 입력하세요</p></div>`:`<strong>연도</strong><p>내용을 입력하세요</p>`,e.appendChild(n),M(t,i.current),o()},onSectionDelete(e,t){let n=e.nextElementSibling;n&&n.tagName===`UL`&&n.remove(),e.remove(),M(t,i.current),o()},onSectionAdd(e){let t=e.querySelector(`.list-wrap`);if(!t)return;let n=document.createElement(`h4`);n.className=`tit-st unit`,n.textContent=`항목명`;let r=document.createElement(`ul`);r.innerHTML=`<li><strong>연도</strong><p>내용을 입력하세요</p></li>`,t.appendChild(n),t.appendChild(r),M(e,i.current),o()},onDlDelete(e,t){e.remove(),M(t,i.current),o()},onDlAdd(e){let t=document.createElement(`dl`);t.className=`his`,t.innerHTML=`<dt>항목명</dt><dd><ul><li><strong>연도</strong><div class="inr"><p>내용을 입력하세요</p></div></li></ul></dd>`;let n=e.querySelector(`dl.his:last-of-type`);n?n.after(t):e.appendChild(t),M(e,i.current),o()},onPDelete(e,t){e.remove(),M(t,i.current),o()},onPAdd(e,t){let n=document.createElement(`p`);n.className=`bu-st3`,n.textContent=`내용을 입력하세요`,e.appendChild(n),M(t,i.current),o()},onHisDlDelete(e,t){e.remove(),M(t,i.current),o()},onHisDlAdd(e){let t=document.createElement(`dl`);t.innerHTML=`<dt>항목명</dt><dd><p class="bu-st3">내용을 입력하세요</p></dd>`,e.appendChild(t),M(e,i.current),o()},onVerseDelete(e,t){e.remove(),M(t,i.current),o()},onVerseAdd(e){let t=e.querySelectorAll(`dl`),n=t.length+1,r=document.createElement(`dl`);r.innerHTML=`<dt>교가 ${n}절</dt><dd>가사를 입력하세요</dd>`;let a=[...t].at(-1);a?a.after(r):e.appendChild(r),M(e,i.current),o()},onTypaItemDelete(e,t){let n=e.nextElementSibling;n?.tagName===`P`&&n.remove(),e.remove(),M(t,i.current),o()},onTypaItemAdd(e){let t=document.createElement(`strong`);t.textContent=`00.00`;let n=document.createElement(`p`);n.textContent=`내용을 입력하세요`;let r=[...e.querySelectorAll(`p`)].at(-1);r?(r.after(n),r.after(t)):(e.appendChild(t),e.appendChild(n)),M(e,i.current),o()},onTypaYearAdd(e){let t=e.closest(`.history.tyA`),n=t?.querySelector(`.historySwiper .swiper-wrapper`),r=t?.querySelector(`.timelineSwiper .swiper-wrapper`);if(!n||!r)return;let a=document.createElement(`div`);a.className=`swiper-slide`,a.dataset.year=`새 연도`,a.setAttribute(`data-block`,`item`),a.innerHTML=`<details><summary>항목 편집</summary><strong>00.00</strong><p>내용을 입력하세요</p></details>`,n.appendChild(a);let s=document.createElement(`div`);s.className=`swiper-slide`,s.setAttribute(`tabindex`,`0`),s.textContent=`새 연도`,r.appendChild(s),M(e,i.current),o()},onTabDelete(e,t){let n=t.closest(`.history`)?.querySelector(`.list-wrap`);if(n){let r=e.querySelector(`a`)?.dataset.target,i=r?n.querySelector(`#${r}`):null;if(i)i.remove();else{let r=[...t.querySelector(`ul`).querySelectorAll(`li`)].indexOf(e),i=[...n.querySelectorAll(`:scope > div.list`)];r>=0&&i[r]&&i[r].remove()}}e.remove(),M(t,i.current),o()},onTabAdd(e){let t=e.closest(`.history`)?.querySelector(`.list-wrap`);if(!t)return;let n=`history${[...t.querySelectorAll(`.list[id^="history"]`)].reduce((e,t)=>Math.max(e,parseInt(t.id.replace(`history`,``))||0),0)+1}`,r=e.querySelector(`ul`),a=document.createElement(`li`);a.innerHTML=`<a href="javascript:void(0);" data-target="${n}">새 기간</a>`;let s=[...r.querySelectorAll(`li`)].at(-1);s?s.after(a):r.appendChild(a);let c=document.createElement(`div`);c.className=`list`,c.id=n,c.innerHTML=`<details><summary>연혁 편집</summary><dl data-block="item"><dt>새 연도</dt><dd><details><summary>항목 편집</summary><ul><li><strong>00.00</strong><div class="inr"><p>내용을 입력하세요</p></div></li></ul></details></dd></dl></details>`;let l=[...t.querySelectorAll(`:scope > div.list`)].at(-1);l?l.after(c):t.appendChild(c),M(e,i.current),o()},onYearAdd(e){let t=document.createElement(`dl`);t.setAttribute(`data-block`,`item`),t.innerHTML=`<dt>새 연도</dt><dd><details><summary>항목 편집</summary><ul><li><strong>00.00</strong><div class="inr"><p>내용을 입력하세요</p></div></li></ul></details></dd>`;let n=[...e.querySelectorAll(`:scope > dl`)].at(-1);n?n.after(t):e.appendChild(t),M(e,i.current),o()},onHistoryLiAdd(e,t){let n=document.createElement(`li`);n.innerHTML=`<strong>00.00</strong><div class="inr"><p>내용을 입력하세요</p></div>`,e.appendChild(n),M(t,i.current),o()}},a.current=()=>{!t||!e.current||e.current.querySelectorAll(`details[open]`).forEach(e=>{M(e,i.current)})},(0,l.useEffect)(()=>{if(!t)return;let n=t=>{let n=t.target;n.tagName===`DETAILS`&&e.current?.contains(n)&&(n.open?M(n,i.current):n.querySelectorAll(`.${ue}`).forEach(e=>e.remove()))};return document.addEventListener(`toggle`,n,!0),()=>document.removeEventListener(`toggle`,n,!0)},[e,t]),a}function de(e,t){let n=document.createElement(`details`);n.innerHTML=`<summary>${t}</summary>`,e.parentNode.insertBefore(n,e),n.appendChild(e)}function fe(e,t,n){if(!t.length)return;let r=document.createElement(`details`);r.innerHTML=`<summary>${n}</summary>`,e.insertBefore(r,t[0]),t.forEach(e=>r.appendChild(e))}function pe(e,t){t===`history`?(e.querySelectorAll(`.year`).forEach(e=>{let t=e.querySelector(`:scope > ul`)||e.querySelector(`.tab-st > ul`);t&&t.parentElement.tagName!==`DETAILS`&&de(t,`탭 편집`)}),e.querySelectorAll(`.list-wrap > div.list`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=[...e.querySelectorAll(`:scope > dl`)];t.length&&fe(e,t,`연혁 편집`)}),e.querySelectorAll(`.history dd`).forEach(e=>{let t=e.querySelector(`:scope > ul`);t&&t.parentElement.tagName!==`DETAILS`&&de(t,`항목 편집`)}),e.querySelectorAll(`.historySwiper .swiper-slide`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=document.createElement(`details`);t.innerHTML=`<summary>항목 편집</summary>`;let n=[...e.childNodes];e.appendChild(t),n.forEach(e=>t.appendChild(e))}),e.querySelectorAll(`.history.tyA .timeline`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=document.createElement(`details`);t.innerHTML=`<summary>연도 관리</summary>`,e.appendChild(t)})):t===`symbol`?e.querySelectorAll(`.lyr`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=[...e.querySelectorAll(`:scope > dl`)];t.length&&fe(e,t,`가사 편집`)}):t===`principal`&&(e.querySelectorAll(`.popup-data`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=document.createElement(`details`);t.innerHTML=`<summary>약력 팝업 내용 편집</summary>`;let n=[...e.childNodes];e.appendChild(t),n.forEach(e=>t.appendChild(e))}),e.querySelectorAll(`.detail-data`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=document.createElement(`details`);t.innerHTML=`<summary>상세정보 내용 편집</summary>`;let n=[...e.childNodes];e.appendChild(t),n.forEach(e=>t.appendChild(e))}),e.querySelectorAll(`.his-wrap`).forEach(e=>{if(e.querySelector(`:scope > details`))return;let t=[...e.querySelectorAll(`:scope > dl`)];t.length&&fe(e,t,`상세정보 내용 편집`)}))}var me=[`.year details`,`.list > details`,`.history dd > details`,`.historySwiper .swiper-slide > details`,`.history.tyA .timeline > details`,`.lyr > details`,`.his-wrap > details`];function he(e){let t=document.createElement(`div`);t.innerHTML=e,t.querySelectorAll(`.${A}`).forEach(e=>e.remove()),t.querySelectorAll(`.${ue}`).forEach(e=>e.remove()),t.querySelectorAll(`[data-block]`).forEach(e=>e.removeAttribute(`data-block`)),me.forEach(e=>{t.querySelectorAll(e).forEach(e=>{e.querySelector(`:scope > summary`)?.remove(),e.replaceWith(...e.childNodes)})});let n=document.createTreeWalker(t,NodeFilter.SHOW_COMMENT),r=[],i;for(;i=n.nextNode();)r.push(i);return r.forEach(e=>e.remove()),t.querySelectorAll(`details`).forEach(e=>{e.querySelector(`:scope > summary`)?.remove(),e.replaceWith(...e.childNodes)}),t.querySelectorAll(`a[href^="javascript:"]`).forEach(e=>{e.setAttribute(`href`,`#`)}),t.innerHTML}function ge(e,t){let n=t=>e.querySelectorAll(t).forEach(e=>e.setAttribute(`data-block`,`item`));t===`principal`?(n(`.swiper-wrapper > .swiper-slide`),n(`.list-wrap > ul > li`)):t===`symbol`?(n(`.list-wrap > .box`),n(`.h-scroll > .box`),n(`.symbol > .box`),n(`.box:not(.song-wrap) > .inner > dl`)):t===`history`&&(n(`.historySwiper .swiper-wrapper > .swiper-slide`),n(`.list-wrap > .list > dl`),n(`.list-wrap > .list > details > dl`))}function _e(e,t,n,r){let i=(0,l.useRef)(r);i.current=r;let[a,o]=(0,l.useState)(null),s=(0,l.useRef)(null);return(0,l.useEffect)(()=>{if(!n)return;let r=t=>{let n=t.target.closest(`[data-block]`);n&&e.current?.contains(n)&&!n.closest(`.popup-data`)&&!n.closest(`.detail-data`)&&(clearTimeout(s.current),o(n))},i=n=>{let r=t?.current??e.current;!r||r.contains(n.relatedTarget)||(s.current=setTimeout(()=>o(null),500))};return document.addEventListener(`mouseover`,r),document.addEventListener(`mouseout`,i),()=>{document.removeEventListener(`mouseover`,r),document.removeEventListener(`mouseout`,i)}},[e,t,n]),{hovered:a,keepHover:(0,l.useCallback)(()=>clearTimeout(s.current),[]),releaseHover:(0,l.useCallback)(()=>{s.current=setTimeout(()=>o(null),500)},[]),deleteBlock:(0,l.useCallback)(()=>{if(!(!a||!e.current)){if(a.closest(`.historySwiper .swiper-wrapper`)){let t=[...a.parentElement.children].indexOf(a);e.current.querySelector(`.timelineSwiper .swiper-wrapper`)?.children[t]?.remove()}a.remove(),o(null),i.current(he(e.current.innerHTML))}},[a,e]),cloneBlock:(0,l.useCallback)(()=>{if(!a||!e.current)return;let t=a.cloneNode(!0);if(a.after(t),a.closest(`.historySwiper .swiper-wrapper`)){let t=[...a.parentElement.children].indexOf(a),n=e.current.querySelector(`.timelineSwiper .swiper-wrapper`)?.children[t];n&&n.after(n.cloneNode(!0))}i.current(he(e.current.innerHTML))},[a,e]),clearHover:(0,l.useCallback)(()=>o(null),[])}}function ve(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function ye(e){if(Array.isArray(e))return e}function be(e,t){var n=e==null?null:typeof Symbol<`u`&&e[Symbol.iterator]||e[`@@iterator`];if(n!=null){var r,i,a,o,s=[],c=!0,l=!1;try{if(a=(n=n.call(e)).next,t!==0)for(;!(c=(r=a.call(n)).done)&&(s.push(r.value),s.length!==t);c=!0);}catch(e){l=!0,i=e}finally{try{if(!c&&n.return!=null&&(o=n.return(),Object(o)!==o))return}finally{if(l)throw i}}return s}}function xe(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Se(e,t){return ye(e)||be(e,t)||Ce(e,t)||xe()}function Ce(e,t){if(e){if(typeof e==`string`)return ve(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?ve(e,t):void 0}}var we=Object.entries,Te=Object.setPrototypeOf,Ee=Object.isFrozen,De=Object.getPrototypeOf,Oe=Object.getOwnPropertyDescriptor,ke=Object.freeze,P=Object.seal,Ae=Object.create,je=typeof Reflect<`u`&&Reflect,Me=je.apply,Ne=je.construct;ke||=function(e){return e},P||=function(e){return e},Me||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},Ne||=function(e){return new e(...[...arguments].slice(1))};var Pe=L(Array.prototype.forEach),Fe=L(Array.prototype.lastIndexOf),Ie=L(Array.prototype.pop),Le=L(Array.prototype.push),Re=L(Array.prototype.splice),F=Array.isArray,ze=L(String.prototype.toLowerCase),Be=L(String.prototype.toString),Ve=L(String.prototype.match),He=L(String.prototype.replace),Ue=L(String.prototype.indexOf),We=L(String.prototype.trim),Ge=L(Number.prototype.toString),Ke=L(Boolean.prototype.toString),qe=typeof BigInt>`u`?null:L(BigInt.prototype.toString),Je=typeof Symbol>`u`?null:L(Symbol.prototype.toString),I=L(Object.prototype.hasOwnProperty),Ye=L(Object.prototype.toString),Xe=L(RegExp.prototype.test),Ze=Qe(TypeError);function L(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return Me(e,t,n)}}function Qe(e){return function(){return Ne(e,[...arguments])}}function R(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:ze;if(Te&&Te(e,null),!F(t))return e;let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(Ee(t)||(t[r]=e),i=e)}e[i]=!0}return e}function $e(e){for(let t=0;t<e.length;t++)I(e,t)||(e[t]=null);return e}function et(e){let t=Ae(null);for(let r of we(e)){var n=Se(r,2);let i=n[0],a=n[1];I(e,i)&&(F(a)?t[i]=$e(a):a&&typeof a==`object`&&a.constructor===Object?t[i]=et(a):t[i]=a)}return t}function tt(e){switch(typeof e){case`string`:return e;case`number`:return Ge(e);case`boolean`:return Ke(e);case`bigint`:return qe?qe(e):`0`;case`symbol`:return Je?Je(e):`Symbol()`;case`undefined`:return Ye(e);case`function`:case`object`:{if(e===null)return Ye(e);let t=e,n=nt(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:Ye(e)}return Ye(e)}default:return Ye(e)}}function nt(e,t){for(;e!==null;){let n=Oe(e,t);if(n){if(n.get)return L(n.get);if(typeof n.value==`function`)return L(n.value)}e=De(e)}function n(){return null}return n}function rt(e){try{return Xe(e,``),!0}catch{return!1}}var it=ke(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),at=ke(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),ot=ke([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),st=ke([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),ct=ke(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),lt=ke([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),ut=ke([`#text`]),dt=ke(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.command.commandfor.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),ft=ke(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),pt=ke(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),mt=ke([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),ht=P(/{{[\w\W]*|^[\w\W]*}}/g),gt=P(/<%[\w\W]*|^[\w\W]*%>/g),_t=P(/\${[\w\W]*/g),vt=P(/^data-[\-\w.\u00B7-\uFFFF]+$/),yt=P(/^aria-[\-\w]+$/),bt=P(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),xt=P(/^(?:\w+script|data):/i),St=P(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ct=P(/^html$/i),wt=P(/^[a-z][.\w]*(-[.\w]+)+$/i),Tt={element:1,text:3,progressingInstruction:7,comment:8,document:9},Et=function(){return typeof window>`u`?null:window},Dt=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},Ot=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function kt(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Et(),t=e=>kt(e);if(t.version=`3.4.5`,t.removed=[],!e||!e.document||e.document.nodeType!==Tt.document||!e.Element)return t.isSupported=!1,t;let n=e.document,r=n,i=r.currentScript,a=e.DocumentFragment,o=e.HTMLTemplateElement,s=e.Node,c=e.Element,l=e.NodeFilter,u=e.NamedNodeMap,d=u===void 0?e.NamedNodeMap||e.MozNamedAttrMap:u,f=e.HTMLFormElement,p=e.DOMParser,m=e.trustedTypes,h=c.prototype,g=nt(h,`cloneNode`),_=nt(h,`remove`),v=nt(h,`nextSibling`),y=nt(h,`childNodes`),b=nt(h,`parentNode`),x=s&&s.prototype?nt(s.prototype,`nodeType`):null;if(typeof o==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let S,C=``,w=n,T=w.implementation,ee=w.createNodeIterator,te=w.createDocumentFragment,E=w.getElementsByTagName,ne=r.importNode,D=Ot();t.isSupported=typeof we==`function`&&typeof b==`function`&&T&&T.createHTMLDocument!==void 0;let re=ht,ie=gt,ae=_t,oe=vt,se=yt,O=xt,k=St,ce=wt,le=bt,A=null,ue=R({},[...it,...at,...ot,...ct,...ut]),j=null,M=R({},[...dt,...ft,...pt,...mt]),N=Object.seal(Ae(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),de=null,fe=null,pe=Object.seal(Ae(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),me=!0,he=!0,ge=!1,_e=!0,ve=!1,ye=!0,be=!1,xe=!1,Se=!1,Ce=!1,Te=!1,Ee=!1,De=!0,Oe=!1,P=`user-content-`,je=!0,Me=!1,Ne={},Ge=null,Ke=R({},[`annotation-xml`,`audio`,`colgroup`,`desc`,`foreignobject`,`head`,`iframe`,`math`,`mi`,`mn`,`mo`,`ms`,`mtext`,`noembed`,`noframes`,`noscript`,`plaintext`,`script`,`style`,`svg`,`template`,`thead`,`title`,`video`,`xmp`]),qe=null,Je=R({},[`audio`,`video`,`img`,`source`,`image`,`track`]),Ye=null,L=R({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),Qe=`http://www.w3.org/1998/Math/MathML`,$e=`http://www.w3.org/2000/svg`,At=`http://www.w3.org/1999/xhtml`,z=At,jt=!1,Mt=null,Nt=R({},[Qe,$e,At],Be),Pt=R({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),Ft=R({},[`annotation-xml`]),It=R({},[`title`,`style`,`font`,`a`,`script`]),Lt=null,Rt=[`application/xhtml+xml`,`text/html`],zt=null,Bt=null,Vt=n.createElement(`form`),Ht=function(e){return e instanceof RegExp||e instanceof Function},Ut=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Bt&&Bt===e)return;(!e||typeof e!=`object`)&&(e={}),e=et(e),Lt=Rt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,zt=Lt===`application/xhtml+xml`?Be:ze,A=I(e,`ALLOWED_TAGS`)&&F(e.ALLOWED_TAGS)?R({},e.ALLOWED_TAGS,zt):ue,j=I(e,`ALLOWED_ATTR`)&&F(e.ALLOWED_ATTR)?R({},e.ALLOWED_ATTR,zt):M,Mt=I(e,`ALLOWED_NAMESPACES`)&&F(e.ALLOWED_NAMESPACES)?R({},e.ALLOWED_NAMESPACES,Be):Nt,Ye=I(e,`ADD_URI_SAFE_ATTR`)&&F(e.ADD_URI_SAFE_ATTR)?R(et(L),e.ADD_URI_SAFE_ATTR,zt):L,qe=I(e,`ADD_DATA_URI_TAGS`)&&F(e.ADD_DATA_URI_TAGS)?R(et(Je),e.ADD_DATA_URI_TAGS,zt):Je,Ge=I(e,`FORBID_CONTENTS`)&&F(e.FORBID_CONTENTS)?R({},e.FORBID_CONTENTS,zt):Ke,de=I(e,`FORBID_TAGS`)&&F(e.FORBID_TAGS)?R({},e.FORBID_TAGS,zt):et({}),fe=I(e,`FORBID_ATTR`)&&F(e.FORBID_ATTR)?R({},e.FORBID_ATTR,zt):et({}),Ne=I(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?et(e.USE_PROFILES):e.USE_PROFILES:!1,me=e.ALLOW_ARIA_ATTR!==!1,he=e.ALLOW_DATA_ATTR!==!1,ge=e.ALLOW_UNKNOWN_PROTOCOLS||!1,_e=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ve=e.SAFE_FOR_TEMPLATES||!1,ye=e.SAFE_FOR_XML!==!1,be=e.WHOLE_DOCUMENT||!1,Ce=e.RETURN_DOM||!1,Te=e.RETURN_DOM_FRAGMENT||!1,Ee=e.RETURN_TRUSTED_TYPE||!1,Se=e.FORCE_BODY||!1,De=e.SANITIZE_DOM!==!1,Oe=e.SANITIZE_NAMED_PROPS||!1,je=e.KEEP_CONTENT!==!1,Me=e.IN_PLACE||!1,le=rt(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:bt,z=typeof e.NAMESPACE==`string`?e.NAMESPACE:At,Pt=I(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?et(e.MATHML_TEXT_INTEGRATION_POINTS):R({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),Ft=I(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?et(e.HTML_INTEGRATION_POINTS):R({},[`annotation-xml`]);let t=I(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?et(e.CUSTOM_ELEMENT_HANDLING):Ae(null);if(N=Ae(null),I(t,`tagNameCheck`)&&Ht(t.tagNameCheck)&&(N.tagNameCheck=t.tagNameCheck),I(t,`attributeNameCheck`)&&Ht(t.attributeNameCheck)&&(N.attributeNameCheck=t.attributeNameCheck),I(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(N.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),ve&&(he=!1),Te&&(Ce=!0),Ne&&(A=R({},ut),j=Ae(null),Ne.html===!0&&(R(A,it),R(j,dt)),Ne.svg===!0&&(R(A,at),R(j,ft),R(j,mt)),Ne.svgFilters===!0&&(R(A,ot),R(j,ft),R(j,mt)),Ne.mathMl===!0&&(R(A,ct),R(j,pt),R(j,mt))),pe.tagCheck=null,pe.attributeCheck=null,I(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?pe.tagCheck=e.ADD_TAGS:F(e.ADD_TAGS)&&(A===ue&&(A=et(A)),R(A,e.ADD_TAGS,zt))),I(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?pe.attributeCheck=e.ADD_ATTR:F(e.ADD_ATTR)&&(j===M&&(j=et(j)),R(j,e.ADD_ATTR,zt))),I(e,`ADD_URI_SAFE_ATTR`)&&F(e.ADD_URI_SAFE_ATTR)&&R(Ye,e.ADD_URI_SAFE_ATTR,zt),I(e,`FORBID_CONTENTS`)&&F(e.FORBID_CONTENTS)&&(Ge===Ke&&(Ge=et(Ge)),R(Ge,e.FORBID_CONTENTS,zt)),I(e,`ADD_FORBID_CONTENTS`)&&F(e.ADD_FORBID_CONTENTS)&&(Ge===Ke&&(Ge=et(Ge)),R(Ge,e.ADD_FORBID_CONTENTS,zt)),je&&(A[`#text`]=!0),be&&R(A,[`html`,`head`,`body`]),A.table&&(R(A,[`tbody`]),delete de.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw Ze(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw Ze(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);S=e.TRUSTED_TYPES_POLICY,C=S.createHTML(``)}else S===void 0&&(S=Dt(m,i)),S!==null&&typeof C==`string`&&(C=S.createHTML(``));ke&&ke(e),Bt=e},Wt=R({},[...at,...ot,...st]),Gt=R({},[...ct,...lt]),Kt=function(e){let t=b(e);(!t||!t.tagName)&&(t={namespaceURI:z,tagName:`template`});let n=ze(e.tagName),r=ze(t.tagName);return Mt[e.namespaceURI]?e.namespaceURI===$e?t.namespaceURI===At?n===`svg`:t.namespaceURI===Qe?n===`svg`&&(r===`annotation-xml`||Pt[r]):!!Wt[n]:e.namespaceURI===Qe?t.namespaceURI===At?n===`math`:t.namespaceURI===$e?n===`math`&&Ft[r]:!!Gt[n]:e.namespaceURI===At?t.namespaceURI===$e&&!Ft[r]||t.namespaceURI===Qe&&!Pt[r]?!1:!Gt[n]&&(It[n]||!Wt[n]):!!(Lt===`application/xhtml+xml`&&Mt[e.namespaceURI]):!1},qt=function(e){Le(t.removed,{element:e});try{b(e).removeChild(e)}catch{_(e)}},Jt=function(e,n){try{Le(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{Le(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(Ce||Te)try{qt(n)}catch{}else try{n.setAttribute(e,``)}catch{}},Yt=function(e){let t=null,r=null;if(Se)e=`<remove></remove>`+e;else{let t=Ve(e,/^[\r\n\t ]+/);r=t&&t[0]}Lt===`application/xhtml+xml`&&z===At&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=S?S.createHTML(e):e;if(z===At)try{t=new p().parseFromString(i,Lt)}catch{}if(!t||!t.documentElement){t=T.createDocument(z,`template`,null);try{t.documentElement.innerHTML=jt?C:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),z===At?E.call(t,be?`html`:`body`)[0]:be?t.documentElement:a},Xt=function(e){return ee.call(e.ownerDocument||e,e,l.SHOW_ELEMENT|l.SHOW_COMMENT|l.SHOW_TEXT|l.SHOW_PROCESSING_INSTRUCTION|l.SHOW_CDATA_SECTION,null)},Zt=function(e){e.normalize();let t=ee.call(e.ownerDocument||e,e,l.SHOW_TEXT|l.SHOW_COMMENT|l.SHOW_CDATA_SECTION|l.SHOW_PROCESSING_INSTRUCTION,null),n=t.nextNode();for(;n;){let e=n.data;Pe([re,ie,ae],t=>{e=He(e,t,` `)}),n.data=e,n=t.nextNode()}},Qt=function(e){return e instanceof f&&(typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||!(e.attributes instanceof d)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`)},$t=function(e){if(!x||typeof e!=`object`||!e)return!1;try{return typeof x(e)==`number`}catch{return!1}};function en(e,n,r){Pe(e,e=>{e.call(t,n,r,Bt)})}let tn=function(e){let n=null;if(en(D.beforeSanitizeElements,e,null),Qt(e))return qt(e),!0;let r=zt(e.nodeName);if(en(D.uponSanitizeElement,e,{tagName:r,allowedTags:A}),ye&&e.hasChildNodes()&&!$t(e.firstElementChild)&&Xe(/<[/\w!]/g,e.innerHTML)&&Xe(/<[/\w!]/g,e.textContent)||ye&&e.namespaceURI===At&&r===`style`&&$t(e.firstElementChild)||e.nodeType===Tt.progressingInstruction||ye&&e.nodeType===Tt.comment&&Xe(/<[/\w]/g,e.data))return qt(e),!0;if(de[r]||!(pe.tagCheck instanceof Function&&pe.tagCheck(r))&&!A[r]){if(!de[r]&&an(r)&&(N.tagNameCheck instanceof RegExp&&Xe(N.tagNameCheck,r)||N.tagNameCheck instanceof Function&&N.tagNameCheck(r)))return!1;if(je&&!Ge[r]){let t=b(e)||e.parentNode,n=y(e)||e.childNodes;if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=g(n[i],!0);t.insertBefore(r,v(e))}}}return qt(e),!0}return e instanceof c&&!Kt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&Xe(/<\/no(script|embed|frames)/i,e.innerHTML)?(qt(e),!0):(ve&&e.nodeType===Tt.text&&(n=e.textContent,Pe([re,ie,ae],e=>{n=He(n,e,` `)}),e.textContent!==n&&(Le(t.removed,{element:e.cloneNode()}),e.textContent=n)),en(D.afterSanitizeElements,e,null),!1)},nn=function(e,t,r){if(fe[t]||De&&(t===`id`||t===`name`)&&(r in n||r in Vt))return!1;let i=j[t]||pe.attributeCheck instanceof Function&&pe.attributeCheck(t,e);if(!(he&&!fe[t]&&Xe(oe,t))&&!(me&&Xe(se,t))){if(!i||fe[t]){if(!(an(e)&&(N.tagNameCheck instanceof RegExp&&Xe(N.tagNameCheck,e)||N.tagNameCheck instanceof Function&&N.tagNameCheck(e))&&(N.attributeNameCheck instanceof RegExp&&Xe(N.attributeNameCheck,t)||N.attributeNameCheck instanceof Function&&N.attributeNameCheck(t,e))||t===`is`&&N.allowCustomizedBuiltInElements&&(N.tagNameCheck instanceof RegExp&&Xe(N.tagNameCheck,r)||N.tagNameCheck instanceof Function&&N.tagNameCheck(r))))return!1}else if(!Ye[t]&&!Xe(le,He(r,k,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&Ue(r,`data:`)===0&&qe[e])&&!(ge&&!Xe(O,He(r,k,``)))&&r)return!1}return!0},rn=R({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),an=function(e){return!rn[ze(e)]&&Xe(ce,e)},on=function(e){en(D.beforeSanitizeAttributes,e,null);let n=e.attributes;if(!n||Qt(e))return;let r={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:j,forceKeepAttr:void 0},i=n.length;for(;i--;){let a=n[i],o=a.name,s=a.namespaceURI,c=a.value,l=zt(o),u=c,d=o===`value`?u:We(u);if(r.attrName=l,r.attrValue=d,r.keepAttr=!0,r.forceKeepAttr=void 0,en(D.uponSanitizeAttribute,e,r),d=r.attrValue,Oe&&(l===`id`||l===`name`)&&Ue(d,P)!==0&&(Jt(o,e),d=P+d),ye&&Xe(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){Jt(o,e);continue}if(l===`attributename`&&Ve(d,`href`)){Jt(o,e);continue}if(r.forceKeepAttr)continue;if(!r.keepAttr){Jt(o,e);continue}if(!_e&&Xe(/\/>/i,d)){Jt(o,e);continue}ve&&Pe([re,ie,ae],e=>{d=He(d,e,` `)});let f=zt(e.nodeName);if(!nn(f,l,d)){Jt(o,e);continue}if(S&&typeof m==`object`&&typeof m.getAttributeType==`function`&&!s)switch(m.getAttributeType(f,l)){case`TrustedHTML`:d=S.createHTML(d);break;case`TrustedScriptURL`:d=S.createScriptURL(d);break}if(d!==u)try{s?e.setAttributeNS(s,o,d):e.setAttribute(o,d),Qt(e)?qt(e):Ie(t.removed)}catch{Jt(o,e)}}en(D.afterSanitizeAttributes,e,null)},sn=function(e){let t=null,n=Xt(e);for(en(D.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)en(D.uponSanitizeShadowNode,t,null),tn(t),on(t),t.content instanceof a&&sn(t.content);en(D.afterSanitizeShadowDOM,e,null)},cn=function(e){if(e.nodeType===Tt.element&&e.shadowRoot instanceof a){let t=e.shadowRoot;cn(t),sn(t)}let t=e.childNodes;if(!t)return;let n=[];Pe(t,e=>{Le(n,e)});for(let e of n)cn(e)};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,o=null,s=null,c=null;if(jt=!e,jt&&(e=`<!-->`),typeof e!=`string`&&!$t(e)&&(e=tt(e),typeof e!=`string`))throw Ze(`dirty is not a string, aborting`);if(!t.isSupported)return e;if(xe||Ut(n),t.removed=[],typeof e==`string`&&(Me=!1),Me){let t=e.nodeName;if(typeof t==`string`){let e=zt(t);if(!A[e]||de[e])throw Ze(`root node is forbidden and cannot be sanitized in-place`)}cn(e)}else if($t(e))i=Yt(`<!---->`),o=i.ownerDocument.importNode(e,!0),o.nodeType===Tt.element&&o.nodeName===`BODY`||o.nodeName===`HTML`?i=o:i.appendChild(o),cn(o);else{if(!Ce&&!ve&&!be&&e.indexOf(`<`)===-1)return S&&Ee?S.createHTML(e):e;if(i=Yt(e),!i)return Ce?null:Ee?C:``}i&&Se&&qt(i.firstChild);let l=Xt(Me?e:i);for(;s=l.nextNode();)tn(s),on(s),s.content instanceof a&&sn(s.content);if(Me)return ve&&Zt(e),e;if(Ce){if(ve&&Zt(i),Te)for(c=te.call(i.ownerDocument);i.firstChild;)c.appendChild(i.firstChild);else c=i;return(j.shadowroot||j.shadowrootmode)&&(c=ne.call(r,c,!0)),c}let u=be?i.outerHTML:i.innerHTML;return be&&A[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&Xe(Ct,i.ownerDocument.doctype.name)&&(u=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+u),ve&&Pe([re,ie,ae],e=>{u=He(u,e,` `)}),S&&Ee?S.createHTML(u):u},t.setConfig=function(){Ut(arguments.length>0&&arguments[0]!==void 0?arguments[0]:{}),xe=!0},t.clearConfig=function(){Bt=null,xe=!1},t.isValidAttribute=function(e,t,n){return Bt||Ut({}),nn(zt(e),zt(t),n)},t.addHook=function(e,t){typeof t==`function`&&Le(D[e],t)},t.removeHook=function(e,t){if(t!==void 0){let n=Fe(D[e],t);return n===-1?void 0:Re(D[e],n,1)[0]}return Ie(D[e])},t.removeHooks=function(e){D[e]=[]},t.removeAllHooks=function(){D=Ot()},t}var At=kt(),z=window.EDITOR_TYPE||`greeting`,jt=[`principal`,`symbol`,`history`],Mt=z===`all`||jt.includes(z);function Nt(e){return e?jt.find(t=>e.startsWith(t+`-`)||e===t)??null:null}function Pt(e){return e&&At.sanitize(e,{ALLOWED_TAGS:`div.p.br.span.strong.em.u.s.a.ul.ol.li.table.thead.tbody.tr.th.td.h1.h2.h3.h4.h5.h6.img.figure.figcaption.blockquote.hr.dl.dt.dd.section.article.button.i.b.details.summary.audio`.split(`.`),ALLOWED_ATTR:[`class`,`style`,`src`,`alt`,`href`,`target`,`width`,`height`,`colspan`,`rowspan`,`data-*`,`id`,`type`,`role`,`aria-hidden`,`aria-expanded`,`aria-controls`,`aria-label`,`aria-live`,`controls`,`download`],ALLOW_DATA_ATTR:!0})}function Ft(e){let t=parseInt(e.slice(1,3),16),n=parseInt(e.slice(3,5),16),r=parseInt(e.slice(5,7),16),i=e=>Math.round(e+(255-e)*.88);return`#${i(t).toString(16).padStart(2,`0`)}${i(n).toString(16).padStart(2,`0`)}${i(r).toString(16).padStart(2,`0`)}`}function It(e,t){let n=getComputedStyle(document.documentElement).getPropertyValue(e).trim();if(!n)return t;if(n.startsWith(`rgb`)){let[e,t,r]=n.match(/\d+/g).map(Number);return`#`+[e,t,r].map(e=>e.toString(16).padStart(2,`0`)).join(``)}return n}function Lt(e,t){if(!e)return e;let n=he(e);return`<div style="${[`--color-primary:${t.primary}`,`--color-secondary:${t.secondary}`,`--color-accent:${t.accent}`,`--color-tertiary:${Ft(t.primary)}`].join(`;`)}">${n}</div>`}function Rt(e,t){let n=document.getElementById(`grtCn`);n&&(n.value=Lt(e,t))}function zt(e){if(!e)return{content:``,colors:null};let t=new DOMParser().parseFromString(e,`text/html`).body.firstElementChild;return t&&t.style.getPropertyValue(`--color-primary`)?{content:t.innerHTML,colors:{primary:t.style.getPropertyValue(`--color-primary`).trim(),secondary:t.style.getPropertyValue(`--color-secondary`).trim(),accent:t.style.getPropertyValue(`--color-accent`).trim()}}:{content:e,colors:null}}function Bt(e,t){let n=t||z;if(!Mt||!e||!jt.includes(n))return e;let r=document.createElement(`div`);return r.innerHTML=e,ge(r,n),pe(r,n),r.innerHTML}function Vt(){let e=zt(window.GREETING_EDITOR_INITIAL_HTML||``),t=Bt(e.content),[n,r]=(0,l.useState)(t),[i,a]=(0,l.useState)(t),[o,s]=(0,l.useState)(!1),[c,u]=(0,l.useState)(()=>e.colors?e.colors:{primary:It(`--color-primary`,`#7c3aed`),secondary:It(`--color-secondary`,`#a78bfa`),accent:It(`--color-accent`,`#ec4899`)}),d=(0,l.useRef)(z===`all`?null:z),f=()=>d.current||`greeting`,p=(0,l.useRef)(null),m=(0,l.useRef)(null),h=(0,l.useRef)(null),g=(0,l.useRef)(null),v=(0,l.useRef)(null),b=(0,l.useRef)(null),x=(0,l.useRef)(null),C=(0,l.useRef)(null),w=(0,l.useRef)(null),[T,ee]=(0,l.useState)(!1),[te,ne]=(0,l.useState)({top:0,left:0}),{hovered:D,keepHover:re,releaseHover:ie,deleteBlock:ae,cloneBlock:oe,clearHover:se}=_e(p,m,Mt,r),O=N(p,Mt,r),ce=(0,l.useRef)(null);ce.current=D;let A=(0,l.useRef)(null),[ue,j]=(0,l.useState)(null),M=(0,l.useCallback)(()=>{let e=ce.current;if(!e)return;let t=t=>{let n=document.elementFromPoint(t.clientX,t.clientY)?.closest(`[data-block]`);if(n&&n!==e&&p.current?.contains(n)&&n.parentElement===e.parentElement){let e=n.getBoundingClientRect(),r=t.clientY<e.top+e.height/2?`before`:`after`;A.current={el:n,pos:r},j({top:r===`before`?e.top:e.bottom,left:e.left,width:e.width})}else A.current=null,j(null)},n=()=>{let i=A.current;if(i){let t=!!e.closest(`.historySwiper .swiper-wrapper`),n=null,a=null;if(t){let t=p.current.querySelector(`.timelineSwiper .swiper-wrapper`);if(t){let r=[...e.parentElement.children].indexOf(e),o=[...i.el.parentElement.children].indexOf(i.el);n=t.children[r]??null,a=t.children[o]??null}}i.pos===`before`?i.el.before(e):i.el.after(e),n&&a&&(i.pos===`before`?a.before(n):a.after(n)),r(he(p.current.innerHTML))}A.current=null,j(null),document.removeEventListener(`mousemove`,t),document.removeEventListener(`mouseup`,n)};document.addEventListener(`mousemove`,t),document.addEventListener(`mouseup`,n)},[]);(0,l.useEffect)(()=>{Rt(n,c)},[n,c]),(0,l.useEffect)(()=>{D&&!p.current?.contains(D)&&se()},[n]),(0,l.useEffect)(()=>{if(p.current&&(Mt?he(p.current.innerHTML):p.current.innerHTML)!==n){let e=new Set;p.current.querySelectorAll(`details`).forEach((t,n)=>{t.open&&e.add(n)}),p.current.innerHTML=n,Mt&&jt.includes(f())&&(ge(p.current,f()),pe(p.current,f())),p.current.querySelectorAll(`details`).forEach((t,n)=>{e.has(n)&&(t.open=!0)}),O.current(),setTimeout(le,50)}},[n,o]);let de=(e,t)=>{z===`all`&&t&&(d.current=Nt(t));let n=Bt(e,f());n||=e,Rt(n,c),r(n),o&&a(n)},fe=()=>{if(o){let e=Pt(i);if(Mt&&jt.includes(f())){let t=document.createElement(`div`);t.innerHTML=e,ge(t,f()),pe(t,f()),e=t.innerHTML}r(e)}else{let e=p.current?p.current.innerHTML:n,t=Mt?he(e):e;a(t),r(t)}s(e=>!e)};(0,l.useEffect)(()=>{let e=()=>ee(!1);return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let me=()=>{setTimeout(()=>{let e=window.getSelection();if(!e||e.isCollapsed||!e.toString().trim())return;let t=p.current;if(!t?.contains(e.anchorNode)||!t?.contains(e.focusNode))return;let n=e.getRangeAt(0);w.current=n.cloneRange();let r=n.getBoundingClientRect();ne({top:r.top-48<8?r.bottom+8:r.top-48,left:Math.min(Math.max(r.left+r.width/2-244/2,8),window.innerWidth-244-8)}),ee(!0)},0)},ve=()=>{p.current&&r(Pt(p.current.innerHTML)),ee(!1)},ye=e=>{e.target.tagName===`IMG`?(e.stopPropagation(),e.nativeEvent?.stopImmediatePropagation(),g.current=e.target,h.current.click()):e.target.closest(`.edu-audio-btn`)?(e.stopPropagation(),e.nativeEvent?.stopImmediatePropagation(),b.current=e.target.closest(`.btn-wrap`)?.querySelector(`audio.edu-audio`)??null,v.current?.click()):e.target.closest(`.edu-score-link`)&&(e.preventDefault(),e.stopPropagation(),e.nativeEvent?.stopImmediatePropagation(),C.current=e.target.closest(`.edu-score-link`),x.current?.click())},be=async e=>{let t=e.target.files[0];if(!t||!g.current)return;let n=g.current;g.current=null,e.target.value=``;let i=n.closest(`[data-block]`),a=i?[...i.querySelectorAll(`p.img > img`)]:[n],o=URL.createObjectURL(t);a.forEach(e=>{e.src=o,e.removeAttribute(`srcset`)});try{let e=document.querySelector(`input[name="sysId"]`)?.value||`EDITOR`,n=new FormData;n.append(`sysId`,e),n.append(`file`,t);let r=await(await fetch(`/common/editer/fileUpload.do`,{method:`POST`,body:n})).json(),i=r.fileStreCours;i?(URL.revokeObjectURL(o),a.forEach(e=>{e.src=i})):console.warn(`이미지 경로를 찾을 수 없습니다. 응답:`,r)}catch(e){console.error(`이미지 업로드 실패:`,e)}r(he(p.current.innerHTML))},xe=async e=>{let t=e.target.files[0];if(!t||!b.current)return;let n=b.current;b.current=null,e.target.value=``;let i=URL.createObjectURL(t);n.src=i;try{let e=document.querySelector(`input[name="sysId"]`)?.value||`EDITOR`,r=new FormData;r.append(`sysId`,e),r.append(`file`,t);let a=(await(await fetch(`/common/editer/fileUpload.do`,{method:`POST`,body:r})).json()).fileStreCours;a&&(URL.revokeObjectURL(i),n.src=a)}catch(e){console.error(`오디오 업로드 실패:`,e)}r(he(p.current.innerHTML))},Se=async e=>{let t=e.target.files[0];if(!t||!C.current)return;let n=C.current;C.current=null,e.target.value=``;let i=URL.createObjectURL(t);n.href=i,n.download=t.name;try{let e=document.querySelector(`input[name="sysId"]`)?.value||`EDITOR`,r=new FormData;r.append(`sysId`,e),r.append(`file`,t);let a=(await(await fetch(`/common/editer/fileUpload.do`,{method:`POST`,body:r})).json()).fileStreCours;a&&(URL.revokeObjectURL(i),n.href=a,n.download=t.name)}catch(e){console.error(`악보 업로드 실패:`,e)}r(he(p.current.innerHTML))},Ce={"--color-primary":c.primary,"--color-secondary":c.secondary,"--color-accent":c.accent,"--color-tertiary":Ft(c.primary),"--color-gray-line":`#d1d5db`,"--color-gray-line-light":`#e5e7eb`,"--color-gray-bg":`#f3f4f6`};return(0,_.jsxs)(`div`,{className:`editor-container`,ref:m,children:[(0,_.jsx)(`input`,{ref:h,type:`file`,accept:`image/*`,style:{display:`none`},onChange:be}),(0,_.jsx)(`input`,{ref:v,type:`file`,accept:`audio/*,video/*`,style:{display:`none`},onChange:xe}),(0,_.jsx)(`input`,{ref:x,type:`file`,accept:`.pdf,.jpg,.jpeg,.png,.gif,.hwp,.doc,.docx`,style:{display:`none`},onChange:Se}),(0,_.jsx)(E,{visible:T,position:te,savedRangeRef:w,colors:c,onApply:ve}),(0,_.jsx)(k,{block:D,onDelete:ae,onClone:oe,onDragStart:M,onMouseEnter:re,onMouseLeave:ie}),ue&&(0,_.jsx)(`div`,{className:`blk-drop-indicator`,style:{top:ue.top,left:ue.left,width:ue.width}}),(0,_.jsx)(y,{onSelect:de}),(0,_.jsx)(S,{colors:c,onChange:u}),(0,_.jsxs)(`div`,{className:`editor-panel`,children:[(0,_.jsxs)(`div`,{className:`toolbar`,children:[(0,_.jsx)(`p`,{className:`bu_atte`,children:`편집 도움말`}),(0,_.jsxs)(`ol`,{className:`bu-st1 list`,style:{fontSize:`14px`},children:[(0,_.jsxs)(`li`,{children:[(0,_.jsx)(`strong`,{children:`이미지 교체`}),` : 사진, 이미지를 클릭하면 파일 선택 창이 열립니다.`]}),(0,_.jsxs)(`li`,{children:[(0,_.jsx)(`strong`,{children:`내용 강조`}),` : 원하는 텍스트를 드래그하면 색상·서식 툴바가 나타납니다.`]}),(0,_.jsxs)(`li`,{children:[(0,_.jsx)(`strong`,{children:`슬라이드·애니메이션`}),` : 우측 `,(0,_.jsx)(`strong`,{children:`미리보기`}),` 버튼으로 실제 동작 확인 가능합니다.`]})]}),(0,_.jsxs)(`div`,{style:{marginLeft:`auto`,display:`flex`,gap:`8px`},children:[(0,_.jsx)(`button`,{type:`button`,className:`ai-btn`,style:{background:`#0ea5e9`},onClick:()=>{let e=Lt(p.current?p.current.innerHTML:n,c);localStorage.setItem(`tmpl_preview`,JSON.stringify({html:e,type:f()})),window.open(`/preview.html`,`_blank`,`noopener`)},children:`👁 미리보기`}),(0,_.jsx)(`button`,{type:`button`,className:`ai-btn`,style:{background:o?`#10b981`:`#475569`},onClick:fe,children:o?`📝 에디터로 돌아가기`:`💻 마크업 보기`})]})]}),o?(0,_.jsx)(`textarea`,{value:i,onChange:e=>{a(e.target.value),r(e.target.value)},style:{width:`100%`,flex:1,minHeight:`500px`,padding:`24px`,fontFamily:`monospace`,fontSize:`14px`,color:`#f8fafc`,backgroundColor:`#0f172a`,border:`none`,resize:`none`,boxSizing:`border-box`,whiteSpace:`pre-wrap`,outline:`none`,lineHeight:`1.5`}}):(0,_.jsx)(`div`,{ref:p,className:`tiptap-wrapper`,style:Ce,contentEditable:!0,suppressContentEditableWarning:!0,onClick:ye,onMouseUp:me,onKeyUp:me,onBlur:e=>{r(Pt(Mt?he(e.currentTarget.innerHTML):e.currentTarget.innerHTML))}})]})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,_.jsx)(l.StrictMode,{children:(0,_.jsx)(Vt,{})}));